...
object Req5DateAreaCityAdvClickApplication {
    ...
    def main(args: Array[String]): Unit = {
        ...
        val dateAdvUserToSumDStream: DStream[(String, Long)] = dateAdvUserToCountDStream.reduceByKey((_: Long)+(_: Long))

        // TODO 3. 对聚合的结果进行阈值的判断
        dateAdvUserToSumDStream.foreachRDD((rdd: RDD[(String, Long)]) =>{
