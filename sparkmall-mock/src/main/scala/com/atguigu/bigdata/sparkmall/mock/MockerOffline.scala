package com.atguigu.bigdata.sparkmall.mock

import java.text.SimpleDateFormat
import java.util.UUID

import com.atguigu.bigdata.sparkmall.common.model.{CityInfo, ProductInfo, UserInfo, UserVisitAction}
import com.atguigu.bigdata.sparkmall.common.util._
